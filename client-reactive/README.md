...
### Gzip support
`InfluxDBClientReactive` does not enable gzip compress for http body by default. If you want to enable gzip to reduce transfer data's size, you can call:
...
```groovy
dependencies {
    compile "com.influxdb:influxdb-client-reactive:1.0.0.M3-SNAPSHOT"
}
```
