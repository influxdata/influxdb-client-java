...
public class TemplateSummarySummaryVariables {
  ...
  public TemplateSummarySummaryVariables kind(TemplateKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public TemplateSummarySummaryVariables templateMetaName(String templateMetaName) {
  ...
  **/
  ...
  public TemplateSummarySummaryVariables id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TemplateSummarySummaryVariables orgID(String orgID) {
    this.orgID = orgID;
    return this;
  }
  ...
  **/
  ...
  public TemplateSummarySummaryVariables name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public TemplateSummarySummaryVariables description(String description) {
  ...
  **/
  ...
  public TemplateSummarySummaryVariables arguments(VariableProperties arguments) {
  ...
  **/
  ...
  public TemplateSummarySummaryVariables labelAssociations(List<TemplateSummaryLabel> labelAssociations) {
    this.labelAssociations = labelAssociations;
    return this;
  }

  public TemplateSummarySummaryVariables addLabelAssociationsItem(TemplateSummaryLabel labelAssociationsItem) {
  ...
  **/
  ...
  public TemplateSummarySummaryVariables envReferences(List<Object> envReferences) {
    this.envReferences = envReferences;
    return this;
  }

  public TemplateSummarySummaryVariables addEnvReferencesItem(Object envReferencesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TemplateSummarySummaryVariables templateSummarySummaryVariables = (TemplateSummarySummaryVariables) o;
    return Objects.equals(this.kind, templateSummarySummaryVariables.kind) &&
        Objects.equals(this.templateMetaName, templateSummarySummaryVariables.templateMetaName) &&
        Objects.equals(this.id, templateSummarySummaryVariables.id) &&
        Objects.equals(this.orgID, templateSummarySummaryVariables.orgID) &&
        Objects.equals(this.name, templateSummarySummaryVariables.name) &&
        Objects.equals(this.description, templateSummarySummaryVariables.description) &&
        Objects.equals(this.arguments, templateSummarySummaryVariables.arguments) &&
        Objects.equals(this.labelAssociations, templateSummarySummaryVariables.labelAssociations) &&
        Objects.equals(this.envReferences, templateSummarySummaryVariables.envReferences);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kind, templateMetaName, id, orgID, name, description, arguments, labelAssociations, envReferences);
  }
  ...
  public static class TemplateSummary_summary_variablesArgumentsAdapter implements JsonDeserializer<Object>, JsonSerializer<Object> {
    ...
    public TemplateSummary_summary_variablesArgumentsAdapter() {
    }
