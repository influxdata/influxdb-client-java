...
public class HistogramViewProperties extends ViewProperties {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, queries, colors, shape, note, showNoteWhenEmpty, xColumn, fillColumns, xDomain, xAxisLabel, position, binCount, legendColorizeRows, legendHide, legendOpacity, legendOrientationThreshold, super.hashCode());
  }
