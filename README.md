...
**Note: This client library is for use with InfluxDB 2.0 and InfluxDB 1.8+. For connecting to InfluxDB 1.7 or earlier instances, please use the [influxdb-java](https://github.com/influxdata/influxdb-java) client library.**
